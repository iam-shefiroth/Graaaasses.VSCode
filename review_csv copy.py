...
def get_all_reviews(url):
    ...
    while True:
        ...
        reviews = amazon_bs.select('h3.arp-local-reviews-header .review-text')          #　ページ内の全レビューのテキストを取得
...
if __name__ == '__main__':
    ...
    for k, url in enumerate(urls):
        ...
        #CSVにレビュー情報の書き出し
        with open(r'z:\UserProfile\s20192087\Desktop\etc\reviewData1.csv','w', encoding='CP932', errors='ignore') as f:
